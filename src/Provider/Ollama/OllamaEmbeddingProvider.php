...
final readonly class OllamaEmbeddingProvider implements EmbeddingProvider
{
    ...
    public function __construct(public string $model, private int $dimensions, AsyncHttpClient $client = new AsyncHttpClient(), private string $baseUrl = 'http://127.0.0.1:11434')
    {
